...
CREATE TABLE `t_ds_relation_process_instance` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_relation_process_instance_pproc_inst_id_ptask_inst_id` (`parent_process_instance_id`,`parent_task_instance_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8;
...
CREATE TABLE `t_ds_task_instance` (
  ...
  `full_log_path` text DEFAULT NULL COMMENT 'full log path',
