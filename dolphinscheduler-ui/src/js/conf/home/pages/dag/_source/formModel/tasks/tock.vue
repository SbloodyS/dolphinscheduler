...
*/
<template>
  <div class="tock-model">

    <m-list-box>
      <div slot="text" style="width: 100px;">{{ $t('Push ClickHouse Spark Param') }}</div>
      <div slot="content">
        <m-spark-params
          ref="refMapColumnAdvancedParams"
          @on-local-params="_onSparkAdvancedParams"
          :udp-list="sparkAdvancedParams"
          :hide="false">
        </m-spark-params>
      </div>
    </m-list-box>
    ...
    <m-list-box>
      <div slot="text" style="width: 100px;">{{ $t('Push ClickHouse Table Param') }}</div>
      <div slot="content">
        <m-ck-params
          ref="refMapColumnAdvancedParams"
          @on-local-params="_onCkAdvancedParams"
          :udp-list="ckAdvancedParams"
          :hide="false">
        </m-ck-params>
      </div>
    </m-list-box>
...
<script>
  ...
  import mSparkParams from './_source/sparkParams'
  import mCkParams from './_source/ckParams.vue'
  ...
  export default {
    ...
    methods: {
      ...
      /**
       * return sparkAdvancedParams
       */
      _onSparkAdvancedParams (a) {
        this.sparkAdvancedParams = a
      },
      /**
       * return ckAdvancedParams
       */
      _onCkAdvancedParams (a) {
        this.ckAdvancedParams = a
      },
      setEditorVal () {
      ...
      _verification () {
        ...
        this.$emit('on-params', {
          ...
          sparkAdvancedParams: this.sparkAdvancedParams,
          ckAdvancedParams: this.ckAdvancedParams
        })
        return true
      },
      /**
    ...
    created () {
      ...
      if (!_.isEmpty(o)) {
        ...
        this.sparkAdvancedParams = o.params.sparkAdvancedParams
        this.ckAdvancedParams = o.params.ckAdvancedParams
      }
    },
    mounted () {
      // setTimeout(() => {
    ...
    // components: { mLocalParams, mListBox, mScriptBox, Treeselect, mSparkParams, mCkParams }
    components: { mListBox, mScriptBox, mSparkParams, mCkParams }
  }
</script>
