...
<template>
  <m-conditions>
    <template slot="search-group">
      ...
      <div class="list">
        <el-input v-model="searchParams.executorName" @keyup.enter.native="_ckQuery" style="width: 100px;" size="mini" :placeholder="$t('Executor')"></el-input>
      </div>
      <div class="list">
      ...
      <div class="list">
        <el-input v-model="searchParams.projectName" @keyup.enter.native="_ckQuery" style="width: 120px;" size="mini" :placeholder="$t('Project Name')"></el-input>
      </div>
      <div class="list">
      ...
      <div class="list">
        <el-input v-model="searchParams.processInstanceId" @keyup.enter.native="_ckQuery" style="width: 120px;" size="mini" :placeholder="$t('ProcessInstanceId')"></el-input>
      </div>
    </template>
  </m-conditions>
</template>
