          ...
          <template slot-scope="scope">
            <el-popover trigger="hover" placement="top">
              ...
              <div slot="reference" class="name-wrapper">
                <router-link :to="{ path: `/projects/${scope.row.projectCode}/definition/list/${scope.row.code}` }" tag="a" class="links">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      _treeView (item) {
        this.$router.push({ path: `/projects/${item.projectCode}/definition/tree/${item.code}` })
      },
      /**
       * Start
       */
       ...
       */
      _timingManage (item) {
        this.$router.push({ path: `/projects/${item.projectCode}/definition/list/timing/${item.code}` })
      },
      /**
       * delete
       */
